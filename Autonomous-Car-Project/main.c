...
uint8 MoveServo180Degrees(){
	...
	// rotate the servo on the specified angles Clock wise or anti clock wise
...
void voidInitMotors(){
	...
	MOTOR1.motor_u8_pin1 = DIO_u8_PIN1;
	MOTOR1.motor_u8_pin2 = DIO_u8_PIN2;

	MOTOR2.motor_u8_port = DIO_u8_PORTC;
	MOTOR2.motor_u8_pin1 = DIO_u8_PIN3;
	MOTOR2.motor_u8_pin2 = DIO_u8_PIN4;
}
...
void voidCheckObstacle_MoveAccordingly(uint32 Copy_32USSDistance, uint8 Copy_u8Dirction){
	 ...
	 // ultrasonic measured distance then move according to the direction of Servo motor
...
char* charptrCarDirection(uint32 Copy_32USSDistance, uint8 Copy_u8Dirction){
	 ...
	 // Describing the current direction the car
